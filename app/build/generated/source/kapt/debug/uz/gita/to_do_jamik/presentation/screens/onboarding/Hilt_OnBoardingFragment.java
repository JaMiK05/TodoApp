...
public abstract class Hilt_OnBoardingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OnBoardingFragment() {
    super();
  }

  Hilt_OnBoardingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OnBoardingFragment_GeneratedInjector) this.generatedComponent()).injectOnBoardingFragment(UnsafeCasts.<OnBoardingFragment>unsafeCast(this));
    }
  }
