...
public abstract class Hilt_AppSplashFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AppSplashFragment() {
    super();
  }

  Hilt_AppSplashFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppSplashFragment_GeneratedInjector) this.generatedComponent()).injectAppSplashFragment(UnsafeCasts.<AppSplashFragment>unsafeCast(this));
    }
  }
