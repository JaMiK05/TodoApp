...
public abstract class Hilt_AddTaskFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddTaskFragment() {
    super();
  }

  Hilt_AddTaskFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddTaskFragment_GeneratedInjector) this.generatedComponent()).injectAddTaskFragment(UnsafeCasts.<AddTaskFragment>unsafeCast(this));
    }
  }
